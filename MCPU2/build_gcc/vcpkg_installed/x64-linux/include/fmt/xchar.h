...
auto vformat_to(OutputIt out, const S &format_str, typename detail::vformat_args<Char>::type args)
    -> OutputIt {
...
template <typename... T>
FMT_DEPRECATED void print(std::FILE *f, const text_style &ts, wformat_string<T...> fmt,
                          const T &...args) {
