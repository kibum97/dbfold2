...
struct cell {
    char X, Y, Z;                      // Coordinates of the cell in the lattice
    struct cell *neighbors[27];        // Pointers to neighboring cells
    short atom_list[MAX_CELL_ATOMS];   // Indices of atoms in the cell
    unsigned char natoms;              // Number of atoms in the cell
};
