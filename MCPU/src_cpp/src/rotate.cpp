...
void DoRotation(
    ...
    temp_xyz.x = ctx->native[b].xyz.x;
    temp_xyz.y = ctx->native[b].xyz.y;
    temp_xyz.z = ctx->native[b].xyz.z;

    v.x = ctx->native[c].xyz.x - temp_xyz.x;
    v.y = ctx->native[c].xyz.y - temp_xyz.y;
    v.z = ctx->native[c].xyz.z - temp_xyz.z;
