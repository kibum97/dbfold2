...
: ${MCPU_CFG_TEMPLATE:="${MCPU_PATH}/user_scripts/template_constraint.cfg"}
...
-e "s:USERVAR_K_CONSTRAINT:${USERVAR_K_CONSTRAINT}:" \
< $MCPU_CFG_TEMPLATE \
> "${run_directory}/cfg"
