...
class ContextMCPU {
   public:
    ...
    void split_positions_by_chain();
    void compute_energy();
    void compute_backbone_vectors();
    void compute_backbone_angles();
    void compute_sidechain_angles();
    void compute_aromatic_centers();
    void compute_aromatic_angles();
    void compute_pairwise_contacts();
    void compute_hydrogen_bonds();
